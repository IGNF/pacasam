WITH FICHIER_LIDAR_REFERENCE AS
  ...
  (SELECT VIGNETTE.ID AS PATCH_ID,
   ...
   FROM VIGNETTE),
     VIGNETTES_AVEC_STATS AS
  (SELECT STAT_VIGNETTE_LIDAR.FICHIER_LIDAR_ID,
          FILE_PATH,
          VIGNETTES_COLS.*,
          NB_TOTAL,
          NB_SOL,
   ...
   FROM VIGNETTES_COLS
   JOIN STAT_VIGNETTE_LIDAR ON VIGNETTES_COLS.PATCH_ID = STAT_VIGNETTE_LIDAR.VIGNETTE_ID
  ...
  (SELECT VIGNETTES_AVEC_STATS.*,
          PRESENCE_DE_SURFACES_D_EAU,
          PRESENCE_DE_PYLONES,
          PRESENCE_D_AUTOROUTES
   FROM VIGNETTES_AVEC_STATS
   LEFT JOIN CROISEMENT_VIGNETTE ON CROISEMENT_VIGNETTE.VIGNETTE_ID = VIGNETTES_AVEC_STATS.PATCH_ID)
